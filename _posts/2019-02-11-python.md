...
---
    ...
    <p>Python is a general-purpose programming language that supports
      procedural, functional, and object-oriented paradigms.</p>
...
$
    ...
    <p>Python supports integers, floating-point numbers. Python can write
      integers using hexadecimal, octal, and binary literals. Python also offers
      a complex number type.</p>
    <pre>&gt;&gt;&gt; type(1)
&lt;class 'int'&gt;
&gt;&gt;&gt; type(1.1)
&lt;class 'float'&gt;
...
&gt;&gt;&gt;
    ...
    <p>Python built-in mathematical functions includes pow, abs, round, int,
      hex, bin, etc. </p>
...
&gt;&gt;&gt;    
    ...
    <p>In Python 3.X there are three string types: str is used for Unicode text
    ...
    <p>Python string formatting <code>'...%s...' % (values)</code>supports all
      the usual C printf format codes. Python also support another kind of
      formatting <code>'...{}...'.format(values)</code>.</p>
    <p>String formating type codes,</p>
    <table>
      <thead>
        <tr>
          <td>Code</td>
    ...
    <h3>Python Lists</h3>
    <p>Python lists are ordered collections of arbitrary objects. Objects are
      accessed by offset.</p>
    ...
    <h3>Python Tuples</h3>
    <p>Tuples are ordered collections of arbitrary objects. Objects are accessed
      by offset. Tuples are immutable</p>
