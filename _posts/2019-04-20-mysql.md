...
<p>DROP DATABASE IF EXISTS mydb;</p>
...
<h4>MySQL Table Properties</h4>
<p>MySQL server data directoryc.</p>
...
<li>Altering Tables -- ALTER TABLE table_name ADD field_name DATE NOT NULL FIRST;</li>
</ul>
